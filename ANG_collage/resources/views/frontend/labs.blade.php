            ...
            <div class="row h_blog_item align-content-center justify-content-center d-flex">
                <div class="col-3 p-0">
                    <div class="h_blog_img pt-5 pl-5 pr-0 pb-0">
                        <img class="img-fluid w-75" src="frontend/style/img/elements/lab.png" alt="" />
                    </div>
                </div>
                <div class="col-9">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="row lab_images d-flex mb-2 " style="gap: 1px;float:left;">
                            <div class="col-12 col-md-12 col-lg-12 d-flex">
                                <img src="{{ asset('galleries/' . $image->images) }}" data-target="#indicators"
                                    class="rounded thumbnail" data-slide-to="0" alt="" />
                            </div>
                        </div>
                    </div>
                @endforeach
